...
import com.example.runningapp.other.Constants.TIMER_UDPATE_INTERVAL
...
class TrackingService : LifecycleService() {
    ...
    private fun updateNotificationTrackingState(isTracking: Boolean){
        ...
        val notificatiomManager = getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager
        ...
        notificatiomManager.notify(NOTIFICATION_ID,curNotificationBuilder.build())
    }
    ...
    private fun createNotificationChannel(notificatiomManager: NotificationManager){
        val channel = NotificationChannel(NOTIFICATION_CHANNEL_ID,
                NOTIFICATION_CHANNEL_NAME, IMPORTANCE_LOW)
        notificatiomManager.createNotificationChannel(channel)
    }
}